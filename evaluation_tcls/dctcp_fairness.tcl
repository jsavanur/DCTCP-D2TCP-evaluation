...
set K 65
set RTT 0.0001
set simulationTime 2.2

set startMeasurementTime 0.001
set stopMeasurementTime 2.1
...
$ns at 0.0 "$ftp(0) send 10000"
$ns at 0.1 "$ftp(0) start"     
$ns at 0.7 "$ftp(0) stop"

$ns at 0.0 "$ftp(1) send 10000"
$ns at 0.3 "$ftp(1) start"     
$ns at 0.9 "$ftp(1) stop"

$ns at 0.0 "$ftp(2) send 10000"
$ns at 0.5 "$ftp(2) start"     
$ns at 1.2 "$ftp(2) stop"

$ns at 0.0 "$ftp(3) send 10000"
$ns at 1.0 "$ftp(3) start"     
$ns at 1.3 "$ftp(3) stop"

$ns at 0.0 "$ftp(4) send 10000"
$ns at 1.1 "$ftp(4) start"     
$ns at 1.4 "$ftp(4) stop"

$ns at 0.0 "$ftp(5) send 10000"
$ns at 1.1 "$ftp(5) start"     
$ns at 1.5 "$ftp(5) stop"

$ns at 0.0 "$ftp(6) send 10000"
$ns at 1.45 "$ftp(6) start"     
$ns at 1.8 "$ftp(6) stop"

$ns at 0.0 "$ftp(7) send 10000"
$ns at 1.6 "$ftp(7) start"     
$ns at 2.0 "$ftp(7) stop"
