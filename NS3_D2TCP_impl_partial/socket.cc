...
{
    static TypeId tid = TypeId("ns3::SocketDeadlineTag").setParent<Tag>().AddConstructot<SocketDeadlineTag>();
    return tid;
}
...
void
SocketDeadlineTag::Serialize(TagBuffer i)
{
...
{
    os << "Deadline finishes at: " << m_deadlineFinish;
}
