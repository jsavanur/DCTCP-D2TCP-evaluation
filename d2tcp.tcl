...
set simulationTime 4.0

set startMeasurementTime 0.0001
set stopMeasurementTime 3.9999
...
for {set i 0} {$i < $N} {incr i} {
    ...
    $tcp($i) set d2tcp_deadline_ [expr $simulationTime]
    $tcp($i) set d2tcp_totalbytes_ 10000.0
